...
// 2 ജമ്പ് സൗണ്ടുകളുടെ അറേ
const jumpSounds = [
  document.getElementById('sound-jump-1'),
  document.getElementById('sound-jump-2')
];
let currentJumpSoundIndex = 0;
let shouldPlayJumpSound = true; // ഒന്നിടവിട്ട് ശബ്ദം വരാനുള്ള സ്വിച്ച്
...
// ഒന്നിടവിട്ട് jump1, jump2 പ്ലേ ചെയ്യുന്ന ഫംഗ്ഷൻ
function playJumpSound() {
  if (shouldPlayJumpSound) {
    playAudio(jumpSounds[currentJumpSoundIndex]);
    currentJumpSoundIndex = (currentJumpSoundIndex + 1) % jumpSounds.length; // 0 (jump1) -> 1 (jump2) -> വീണ്ടും 0
  }
  shouldPlayJumpSound = !shouldPlayJumpSound; // അടുത്ത ടാപ്പിൽ സൗണ്ട് ഒഴിവാക്കാനായി മാറ്റുന്നു
}
...
const bird = {
  ...
  flap() {
    ...
    playJumpSound(); // ഒന്നിടവിട്ട് jump1, jump2 പ്ലേ ആകുന്നു
  },
...
function resetGame() {
  ...
  // തുടക്കത്തിലേക്ക് റീസെറ്റ് ചെയ്യുന്നു
